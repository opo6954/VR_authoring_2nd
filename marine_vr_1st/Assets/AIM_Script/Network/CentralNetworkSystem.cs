...
public class CentralNetworkSystem : Photon.PunBehaviour
{
...
5: passenger escape
    */
    ...
    public override void OnJoinedRoom() // 아무 player나 방에 join하면 callback되는 함수. --> 나만 실행되는 곳임...
    {
        ...
        if (player_num == 1)
        {
            player = PhotonNetwork.Instantiate("Player_Char/Player_1", Vector3.zero, Quaternion.identity, 0); // Player 1 spawn
